...
- 1M の対SPY超過リターンは +4.20pt で、市場並み以上です。
- 3M の対SPY超過リターンは -4.99pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンが +14.96pt と、市場を大きく上回っています。
...
- excess_returns: {'1M': 4.2, '3M': -4.99, '6M': 14.96, '1Y': -6.43}
- latest_volume: 28,294,255.0000
- average_volume_30d: 44,366,985.1667
...
- イベント後の平均株価反応が -2.16% と弱く、注意が必要です。
