...
- 1M の対SPY超過リターンは -5.44pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは +0.91pt で、市場並み以上です。
- 6M の対SPY超過リターンは +6.84pt で、市場並み以上です。
- 1Y の対SPY超過リターンは -9.05pt と、市場を小幅に下回っています。
...
- excess_returns: {'1M': -5.44, '3M': 0.91, '6M': 6.84, '1Y': -9.05}
- latest_volume: 28,792,611.0000
- average_volume_30d: 42,444,440.3667
