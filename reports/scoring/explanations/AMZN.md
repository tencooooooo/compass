...
- PEG はセクター内 25.00 パーセンタイル / 母数 9 で、相対的に割安寄りです。
...
- 3M の対SPY超過リターンは -6.15pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -5.24pt と、市場を小幅に下回っています。
- 1Y の対SPY超過リターンは -11.08pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 1.09, '3M': -6.15, '6M': -5.24, '1Y': -11.08}
- latest_volume: 25,711,227.0000
- average_volume_30d: 53,830,530.9000
