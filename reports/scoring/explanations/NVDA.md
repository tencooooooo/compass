...
- 3M の対SPY超過リターンは -6.35pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは +3.22pt で、市場並み以上です。
- 1Y の対SPY超過リターンは -1.18pt と、市場を小幅に下回っています。
...
- excess_returns: {'1M': 2.18, '3M': -6.35, '6M': 3.22, '1Y': -1.18}
- latest_volume: 96,854,269.0000
- average_volume_30d: 120,634,842.3000
