...
- 3M の対SPY超過リターンは -2.52pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは +0.90pt で、市場並み以上です。
- 1Y の対SPY超過リターンは +3.16pt で、市場並み以上です。
...
- excess_returns: {'1M': -1.99, '3M': -2.52, '6M': 0.9, '1Y': 3.16}
- latest_volume: 113,202,886.0000
- average_volume_30d: 159,205,572.8667
...
- イベント後の平均株価反応が -3.52% と弱く、注意が必要です。
