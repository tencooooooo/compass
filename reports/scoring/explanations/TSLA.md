...
- PEG はセクター内 100.00 パーセンタイル / 母数 9 で、相対的な加点は抑えています。
...
- trailing_pe: 354.1402
- forward_pe: 147.6694
- peg_ratio: 4.7700
- price_to_book: 16.9158
...
- 1M の対SPY超過リターンは -5.59pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -9.31pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -22.15pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -5.60pt と、市場を小幅に下回っています。
...
- excess_returns: {'1M': -5.59, '3M': -9.31, '6M': -22.15, '1Y': -5.6}
- latest_volume: 31,140,392.0000
- average_volume_30d: 43,392,889.7333
