...
- 1M の対SPY超過リターンは -3.99pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは +1.88pt で、市場並み以上です。
- 6M の対SPY超過リターンは -21.74pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -47.54pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -3.99, '3M': 1.88, '6M': -21.74, '1Y': -47.54}
- latest_volume: 9,883,241.0000
- average_volume_30d: 4,686,878.0333
...
- イベント後の平均株価反応が -2.37% と弱く、注意が必要です。
