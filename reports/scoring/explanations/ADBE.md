...
- 1M の対SPY超過リターンは +9.46pt で、市場並み以上です。
- 3M の対SPY超過リターンは +7.48pt で、市場並み以上です。
- 6M の対SPY超過リターンは -9.83pt と、市場を小幅に下回っています。
- 1Y の対SPY超過リターンは -39.88pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 9.46, '3M': 7.48, '6M': -9.83, '1Y': -39.88}
- latest_volume: 3,777,838.0000
- average_volume_30d: 4,780,814.6000
...
- イベント後の平均株価反応が -2.23% と弱く、注意が必要です。
