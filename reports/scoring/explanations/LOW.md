...
- PBR は -15.07 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは -7.56pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -4.88pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -34.15pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -42.01pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -7.56, '3M': -4.88, '6M': -34.15, '1Y': -42.01}
- latest_volume: 2,728,712.0000
- average_volume_30d: 3,038,723.7333
...
- イベント後の平均株価反応が -1.19% と弱く、注意が必要です。
