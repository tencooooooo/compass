...
- PBR は -14.22 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは -12.63pt と、市場を大きく下回っています。
- 3M の対SPY超過リターンは -18.03pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは -35.62pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -41.38pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -12.63, '3M': -18.03, '6M': -35.62, '1Y': -41.38}
- latest_volume: 2,934,800.0000
- average_volume_30d: 3,192,651.4000
...
- イベント後の平均株価反応が -2.41% と弱く、注意が必要です。
