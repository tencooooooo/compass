...
- PBR は -14.28 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは -12.58pt と、市場を大きく下回っています。
- 3M の対SPY超過リターンは -19.28pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは -36.71pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -42.89pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -12.58, '3M': -19.28, '6M': -36.71, '1Y': -42.89}
- latest_volume: 3,741,600.0000
- average_volume_30d: 3,248,110.0000
...
- イベント後の平均株価反応が -1.50% と弱く、注意が必要です。
