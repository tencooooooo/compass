...
- PBR は -13.31 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは +5.99pt で、市場並み以上です。
- 3M の対SPY超過リターンは -3.72pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -33.82pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -31.38pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 5.99, '3M': -3.72, '6M': -33.82, '1Y': -31.38}
- latest_volume: 4,956,178.0000
- average_volume_30d: 2,978,029.2667
