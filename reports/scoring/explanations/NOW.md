...
- 1M の対SPY超過リターンは +4.25pt で、市場並み以上です。
- 3M の対SPY超過リターンが +18.86pt と、市場を大きく上回っています。
- 6M の対SPY超過リターンは -0.75pt と、市場を小幅に下回っています。
- 1Y の対SPY超過リターンは -49.02pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 4.25, '3M': 18.86, '6M': -0.75, '1Y': -49.02}
- latest_volume: 10,269,432.0000
- average_volume_30d: 18,961,534.4000
...
- イベント後の平均株価反応が -4.10% と弱く、注意が必要です。
