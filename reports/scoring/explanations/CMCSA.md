...
- 1M の対SPY超過リターンは -0.22pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは +1.70pt で、市場並み以上です。
- 6M の対SPY超過リターンは -28.22pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -0.22, '3M': 1.7, '6M': -28.22, '1Y': -34.19}
- latest_volume: 23,631,229.0000
- average_volume_30d: 23,570,964.3000
