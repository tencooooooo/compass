...
- 1M の対SPY超過リターンは -4.79pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは +0.91pt で、市場並み以上です。
- 6M の対SPY超過リターンは -32.12pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -33.98pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -4.79, '3M': 0.91, '6M': -32.12, '1Y': -33.98}
- latest_volume: 24,263,359.0000
- average_volume_30d: 22,843,995.3000
...
- イベント後の平均株価反応が -2.22% と弱く、注意が必要です。
