...
- Forward PER はセクター内 21.43 パーセンタイル / 母数 15 で、相対的に割安寄りです。
...
- forward_pe: 13.5089
- peg_ratio: 0.8300
- price_to_book: 7.2674
- sector_peer_count: 16
- trailing_pe_percentile: 28.5700
- trailing_pe_peer_count: 15
- forward_pe_percentile: 21.4300
...
- 1M の対SPY超過リターンは +3.35pt で、市場並み以上です。
- 3M の対SPY超過リターンは -21.88pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは -20.77pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -67.59pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 3.35, '3M': -21.88, '6M': -20.77, '1Y': -67.59}
- latest_volume: 39,215,400.0000
- average_volume_30d: 28,492,433.3333
