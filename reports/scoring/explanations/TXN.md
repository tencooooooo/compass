...
- 1M の対SPY超過リターンは -3.34pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -16.10pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンが +23.28pt と、市場を大きく上回っています。
- 1Y の対SPY超過リターンが +31.52pt と、市場を大きく上回っています。
...
- excess_returns: {'1M': -3.34, '3M': -16.1, '6M': 23.28, '1Y': 31.52}
- latest_volume: 4,409,988.0000
- average_volume_30d: 5,553,912.9333
...
- ニュース見出し・要約の簡易分類では、好材料 6 件、悪材料 3 件(純比率 +0.33)で、センチメントは 5.3 点です。
