...
- 3M の対SPY超過リターンは -18.48pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは +6.50pt で、市場並み以上です。
- 1Y の対SPY超過リターンが +10.89pt と、市場を大きく上回っています。
...
- excess_returns: {'1M': -10.23, '3M': -18.48, '6M': 6.5, '1Y': 10.89}
- latest_volume: 6,417,216.0000
- average_volume_30d: 7,304,827.2000
