...
- 1M の対SPY超過リターンは -4.24pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは +9.62pt で、市場並み以上です。
- 6M の対SPY超過リターンは -26.31pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -34.48pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -4.24, '3M': 9.62, '6M': -26.31, '1Y': -34.48}
- latest_volume: 4,280,316.0000
- average_volume_30d: 3,655,737.2000
