...
- 1M の対SPY超過リターンは -8.38pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -35.84pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは +1.57pt で、市場並み以上です。
- 1Y の対SPY超過リターンは -16.44pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -8.38, '3M': -35.84, '6M': 1.57, '1Y': -16.44}
- latest_volume: 10,497,754.0000
- average_volume_30d: 11,384,388.4667
...
- イベント後の平均株価反応が -1.18% と弱く、注意が必要です。
