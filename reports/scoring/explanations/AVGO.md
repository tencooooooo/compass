...
- 3M の対SPY超過リターンは -19.29pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは +3.09pt で、市場並み以上です。
- 1Y の対SPY超過リターンは +3.43pt で、市場並み以上です。
...
- excess_returns: {'1M': -8.64, '3M': -19.29, '6M': 3.09, '1Y': 3.43}
- latest_volume: 16,481,416.0000
- average_volume_30d: 19,086,203.8667
