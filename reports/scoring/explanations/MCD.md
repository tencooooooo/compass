...
- PBR は -182.25 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは -5.30pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -5.29pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -32.66pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -33.06pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -5.3, '3M': -5.29, '6M': -32.66, '1Y': -33.06}
- latest_volume: 5,209,936.0000
- average_volume_30d: 4,486,601.2000
