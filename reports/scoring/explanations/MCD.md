...
- PBR は -183.26 で、指標がマイナスのため加点対象外です。
...
- 3M の対SPY超過リターンは -6.41pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -34.08pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -33.14pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -5.01, '3M': -6.41, '6M': -34.08, '1Y': -33.14}
- latest_volume: 3,882,072.0000
- average_volume_30d: 4,435,875.7333
