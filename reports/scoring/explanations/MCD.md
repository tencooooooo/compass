...
- PBR は -180.57 で、指標がマイナスのため加点対象外です。
...
- 1M の対SPY超過リターンは -2.10pt と、市場を小幅に下回っています。
- 3M の対SPY超過リターンは -6.07pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -33.43pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -34.11pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': -2.1, '3M': -6.07, '6M': -33.43, '1Y': -34.11}
- latest_volume: 3,697,196.0000
- average_volume_30d: 4,492,996.5333
