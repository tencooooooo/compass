...
- 3M の対SPY超過リターンは -8.51pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは +0.57pt で、市場並み以上です。
- 1Y の対SPY超過リターンが +74.00pt と、市場を大きく上回っています。
...
- excess_returns: {'1M': 2.05, '3M': -8.51, '6M': 0.57, '1Y': 74.0}
- latest_volume: 38,121,117.0000
- average_volume_30d: 35,051,380.5667
