...
- 1M の対SPY超過リターンは +4.49pt で、市場並み以上です。
- 3M の対SPY超過リターンは -10.99pt と、市場を大きく下回っています。
- 6M の対SPY超過リターンは -35.45pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -57.93pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 4.49, '3M': -10.99, '6M': -35.45, '1Y': -57.93}
- latest_volume: 33,754,561.0000
- average_volume_30d: 31,167,442.0333
...
- イベント後の平均株価反応が -1.89% と弱く、注意が必要です。
