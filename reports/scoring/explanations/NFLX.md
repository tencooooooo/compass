...
- 1M の対SPY超過リターンは +5.98pt で、市場並み以上です。
- 3M の対SPY超過リターンは -9.48pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -36.13pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -57.74pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 5.98, '3M': -9.48, '6M': -36.13, '1Y': -57.74}
- latest_volume: 39,850,506.0000
- average_volume_30d: 31,338,126.8667
...
- イベント後の平均株価反応が -5.35% と弱く、注意が必要です。
