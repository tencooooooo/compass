...
- 1M の対SPY超過リターンは +1.47pt で、市場並み以上です。
- 3M の対SPY超過リターンは -4.32pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -31.21pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -44.25pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 1.47, '3M': -4.32, '6M': -31.21, '1Y': -44.25}
- latest_volume: 3,348,663.0000
- average_volume_30d: 4,349,552.1000
