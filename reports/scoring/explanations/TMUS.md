...
- 1M の対SPY超過リターンは +4.08pt で、市場並み以上です。
- 3M の対SPY超過リターンは -1.47pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -29.05pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -46.25pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 4.08, '3M': -1.47, '6M': -29.05, '1Y': -46.25}
- latest_volume: 4,198,100.0000
- average_volume_30d: 4,403,963.3333
