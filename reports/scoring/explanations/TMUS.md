...
- 1M の対SPY超過リターンは +0.90pt で、市場並み以上です。
- 3M の対SPY超過リターンは -5.25pt と、市場を小幅に下回っています。
- 6M の対SPY超過リターンは -28.75pt と、市場を大きく下回っています。
- 1Y の対SPY超過リターンは -46.78pt と、市場を大きく下回っています。
...
- excess_returns: {'1M': 0.9, '3M': -5.25, '6M': -28.75, '1Y': -46.78}
- latest_volume: 3,105,620.0000
- average_volume_30d: 4,638,254.0000
