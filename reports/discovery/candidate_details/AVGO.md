...
- 1Mモメンタムは対SPYで -10.54pt と弱く、候補評価では注意点です。
- 3Mモメンタムは対SPYで -17.64pt と弱く、候補評価では注意点です。
- 6Mモメンタムは対SPYで -2.02pt と、市場を小幅に下回っています。
...
- valuation_score: 8.0
- news_score: 15.0
- momentum: {'1m': -6.90987184958486, '3m': -15.332675240988477, '6m': 10.004647809615028, '1y': 22.22919998268456}
- benchmark: SPY
- excess_momentum: {'1m': -10.54, '3m': -17.64, '6m': -2.02, '1y': 2.23}
- positive_news: 2
- watch_news: 0
- event_count: 10
- events_with_reaction: 8
- sector_average_score: 68.25
